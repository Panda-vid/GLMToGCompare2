...
if __name__ == "__main__":
    ...
    eval_pipeline_builder = EvalPipeline.Builder().is_classification_task(problem_type_to_classification_bool(args.problem_type)).set_eval_data(eval_data).add_model_recipe(model_recipe).set_device(args.device).set_batch_size(args.batch_size).set_repetitions(args.repetitions)
